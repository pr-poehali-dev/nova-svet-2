...
export function SendFundsCard() {
  return (
    <div className="rounded-2xl bg-[#141414] border border-[#262626] p-6 flex flex-col">
      ...
      <h3 className="mb-2 text-lg font-semibold text-white">Быстрый расчёт стоимости</h3>
      <p className="mb-4 text-sm text-gray-400">Оставьте заявку — рассчитаем предварительную стоимость проекта за 24 часа</p>
      ...
      <div className="mt-auto space-y-4 rounded-xl bg-[#1a1a1a] border border-[#262626] p-4">
        <div className="flex items-center justify-between rounded-lg bg-[#0f0f0f] border border-[#262626] px-3 py-2.5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-white">Тип объекта</p>
              <p className="text-xs text-gray-500">Жилое / Коммерческое / Промышленное</p>
            </div>
          </div>
        ...
        <div>
          <label className="mb-2 flex items-center gap-1 text-xs text-gray-400">
            Описание задачи <span className="text-violet-400">*</span>
          </label>
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <span className="text-sm text-gray-400">Нужна экспертиза проекта</span>
        </div>
      </div>
    </div>
  )
